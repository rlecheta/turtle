 ...
 * @author rlecheta
 */
public abstract class CopyOfSprite extends javax.microedition.lcdui.game.Sprite {
	...
	public int state;
	long stateTime;
	public int[] frameAnimacao;
	public int[] frameMorrendo;

	/*
	 * Cria um novo objeto Sprite com a animação especificada.
	 */
	public CopyOfSprite(Bitmap image, int frameWidth, int frameHeight) {
	...
	protected void setFrame(int[] frame) {
		if(frameAnimacao == null) {
			// A primeira vez faz cache deste frame
			// Talvez precise recuperar ele ao reviver um sprite
			// Onde o estado do this.frame estara com o framemorrendo
			frameAnimacao = frame;
		}
